...
<Library LVVersion="12008004">
	...
	<Property Name="NI.Lib.Description" Type="Str">This library contains the actors and messages that comprise a State Pattern Actor.  The actor launches a single Process Actor as a nested actor.  Process State.lvclass is the context actor.  Idle.lvclass and Running.lvclass are the two supported states.  </Property>
